...
export const metadata: Metadata = {
  title: 'News | Pacific Athletic League',
  description: 'Latest league news, game recaps, trade updates, and community stories from Pacific Athletic League.',
}
...
async function getNews() {
  try {
    ...
    const { data } = await apolloClient.query<NewsData>({ query: GET_NEWS, variables: { first: 50 }, fetchPolicy: 'cache-first' })
      ...
      <section className="relative bg-gradient-to-r from-primary-800 via-primary-900 to-primary-800 text-white py-16 md:py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold mb-6 uppercase">League News</h1>
            <p className="text-xl text-primary-200 max-w-3xl mx-auto">League updates, game recaps, trade news, and community stories.</p>
          </div>
        </div>
      </section>
